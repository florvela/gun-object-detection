...
parser.add_argument('--config', type=str, help='path to config file.', default='./configs/vgg16_flor.json')
parser.add_argument('--weights', type=str, help='path to the weight file.', default='./output/cp_ep_3_loss_23.1610.h5')
