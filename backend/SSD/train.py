...
args = {
    ...
    'images_dir': './datasets/merged_dataset/Images/',
    'labels_dir': './datasets/merged_dataset/Labels/',
    'training_split': './datasets/merged_dataset/train_split_file.csv',
    'validation_split': './datasets/merged_dataset/val_split_file.csv',
    'label_maps': ['gun'],
    'checkpoint': './output_2/cp_ep_100_loss_17.3806.h5', # can be an existing h5 to load weights from and continue training
