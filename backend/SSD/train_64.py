...
args = {
    ...
    'checkpoint': '/content/drive/MyDrive/ssd_train_output_64_batches/cp_ep_110_loss_13.8728.h5', #'/content/drive/MyDrive/ssd_train_output/cp_ep_170_loss_6.5020.h5', #'/content/drive/MyDrive/ssd_train_output/cp_ep_100_loss_7.3720.h5', #'/content/drive/MyDrive/ssd_train_output/cp_ep_30_loss_11.7435.h5', #'./output_2/cp_ep_100_loss_17.3806.h5', # can be an existing h5 to load weights from and continue training
    'checkpoint_type': 'epoch',
    ...
    'shuffle': True,
    'augment': False,
    'output_dir': '/content/drive/MyDrive/ssd_train_output_64_batches'
}
