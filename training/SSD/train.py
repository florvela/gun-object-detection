...
args = {
    ...
    'checkpoint': "/content/drive/MyDrive/ssd_train_output_64_batches_001_lr_augmented_adam/cp_ep_40_loss_3.3862.h5", #'/content/drive/MyDrive/ssd_train_output_64_batches_001_lr_not_augmented/cp_ep_160_loss_4.9648.h5', #'/content/drive/MyDrive/ssd_train_output/cp_ep_100_loss_7.3720.h5', #'/content/drive/MyDrive/ssd_train_output/cp_ep_30_loss_11.7435.h5', #'./output_2/cp_ep_100_loss_17.3806.h5', # can be an existing h5 to load weights from and continue training
    ...
    'shuffle': True,
    'augment': True,
    'output_dir': '/content/drive/MyDrive/ssd_train_output_64_batches_001_lr_augmented_adam'
}
